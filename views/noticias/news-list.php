            ...
            <div class="card-body">
                <div id="newsTableContainer">
                    ...
                    <script>
                        ...
                        function submitCreateNewsForm(event) {
                            ...
                            fetch("<?= BASE_URL ?>noticias/news-create", {
                                    method: 'POST',
                                    body: formData
                                })
                                .then(response => response.json())
                ...
                `;
                        ...
                        function submitEditNewsForm(event) {
                            ...
                            fetch(`<?= BASE_URL ?>noticias/news-update/${newsId}`, {
                                    method: 'POST',
                                    body: formData
                                })
                                .then(response => response.json())
                        ...
                        document.getElementById('confirmDelete').addEventListener('click', function() {
                            if (deleteNewsId) {
                                fetch(`<?= BASE_URL ?>noticias/news-delete/${deleteNewsId}`, {
                                        method: 'POST',
                                        headers: {
                                            'Content-Type': 'application/x-www-form-urlencoded',
                                        },
